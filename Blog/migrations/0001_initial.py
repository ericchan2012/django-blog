# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-07-07 03:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('navigation', models.CharField(choices=[('n', '\u65b0\u95fb'), ('t', '\u6559\u7a0b'), ('r', '\u8d44\u6e90')], default='n', max_length=1, verbose_name='\u5bfc\u822a\u540d\u5b57')),
                ('abstract', models.CharField(blank=True, help_text='\u53ef\u9009\uff0c\u5982\u82e5\u4e3a\u7a7a\u5c06\u6458\u53d6\u6b63\u6587\u7684\u524d150\u4e2a\u5b57\u7b26', max_length=150, null=True, verbose_name='\u6458\u8981')),
                ('views', models.PositiveIntegerField(default=0, verbose_name='\u6d4f\u89c8\u91cf')),
                ('likes', models.PositiveIntegerField(default=0, verbose_name='\u70b9\u8d5e\u6570')),
                ('topped', models.BooleanField(default=False, verbose_name='\u7f6e\u9876')),
                ('thumbnail', models.ImageField(upload_to='upload/thumbnail', verbose_name='\u5c01\u9762')),
            ],
            options={
